...
<div class="wrapper-page">
    <div class="panel panel-color panel-primary panel-pages">
        <div class="panel-heading bg-img">
            ...
            <h3 class="text-center m-t-10 text-white"> 简·存取后台管理系统</strong> </h3>
        </div>


        <div class="panel-body">
            <form action="admin/login" class="form-horizontal m-t-20" id="login-form" method="post" onsubmit="return check();">
			<span style="color:red;">${login_error}</span>	
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-primary btn-lg w-lg waves-effect waves-light" onclick="login(this)"
                                type="submit">登录
                        </button>
                    </div>
                </div>
