...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑《 ${Journal_reduce.jsrq}》</h3>
        </div>
        <div class="panel-body">
            <form action="/doupdateJournal_reduce" method="post" id="addbook" >

                <div class="input-group">
                    <span class="input-group-addon">减少日期</span>
                    <input type="text" class="form-control" readonly="readonly" name="jsrq" id="jsrq" value="${Journal_reduce.jsrq}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">减少原因</span>
                    <input type="text" class="form-control" name="jsyy" id="jsyy" value="${Journal_reduce.jsyy}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">减少结果</span>
                    <input type="text" class="form-control" name="jsjg" id="jsjg" value="${Journal_reduce.jsjg}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">经办人职工号</span>
                    <input type="text" class="form-control" name="jsrzgh" id="jsrzgh" value="${Journal_reduce.jsrzgh}">
                </div>
                ...
                <script>
                    ...
                    $("#addbook").submit(function () {
                        if($("#jsrq").val()==''||$("#jsrzgh").val()==''||$("#jsjg").val()==''||$("#jsyy").val()==''){
                            alert("请填入完整图书信息！");
