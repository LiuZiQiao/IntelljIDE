...
<%@page import="com.lxk.book.entitys.Journal_subscribe" %>
<html>
<head>
    <title>全部图书信息</title>
...
<div class="panel panel-default" style="position: relative;top: 80px ;width: 90%;margin-left: 5%">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody>
            <c:forEach items="${journal_subscribe}" var="book">
            <tr>
                <td><c:out value="${book.qkdgh}"></c:out></td>
                <td><c:out value="${book.ydjg}"></c:out></td>
                <td><c:out value="${book.ydcs}"></c:out></td>
                <td><c:out value="${book.ydnd}"></c:out></td>
