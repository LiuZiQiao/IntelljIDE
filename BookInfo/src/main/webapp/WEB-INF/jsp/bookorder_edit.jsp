...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="doaupdatebook_order.html?id=${books.dgh}" method="post" id="addbook" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="ydjg" id="ydjg" value="${books.ydjg}" >
                </div>
                <div class="input-group">
                    <span  class="input-group-addon">预定册数</span>
                    <input type="text" class="form-control" name="ydcs" id="ydcs"  value="${books.ydcs}" >
                </div>

                <div class="input-group">
                    <span  class="input-group-addon">预定日期</span>
                    <input type="text" class="form-control" name="ydrq" id="ydrq" value="${books.ydrq}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">获得方式码</span>
                    <input type="text" class="form-control" name="hdfsm" id="hdfsm"  value="${books.hdfsm}" >
                </div>
                <div class="input-group">
                    <span  class="input-group-addon">征订人职工号</span>
                    <input type="text" class="form-control" name="zdrzgh" id="zdrzgh"  value="${books.zdrzgh}" >
                </div>
                <div class="input-group">
                ...
                <script>
                    ...
                    $("#addbook").submit(function () {
                        if($("#dgh").val()==''||$("#ydcs").val()==''||$("ydjg").val()==''
                            ||$("ydrq").val()==''||$("hdfsm").val()==''||$("#zdrzgh").val()==''||$("#bz").val()==''){
                            alert("请填入完整订购图书信息！");
