...
<div style="position: relative;top: 10%;width: 80%;margin-left: 10%">
            <form action="/addJournal_len_return" method="post" id="addbook" >
                <div class="input-group">
                    <span class="input-group-addon">借阅日期</span>
                    <input type="text" class="form-control" name="jyrq" id="jyrq" placeholder="请输入借阅日期">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">借阅人</span>
                    <input type="text" class="form-control" name="jyr" id="jyr" placeholder="请输入借阅人">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">归还日期</span>
                    <input type="text" class="form-control" name="ghrq" id="ghrq" placeholder="请输入归还日期">
                </div>
                <div class="input-group">
