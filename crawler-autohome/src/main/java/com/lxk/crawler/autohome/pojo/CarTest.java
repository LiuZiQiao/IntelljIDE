package com.lxk.crawler.autohome.pojo;
...
public class CarTest {
    ...
    public Integer getTest_speed() {
        return test_speed;
    }

    public void setTest_speed(Integer test_speed) {
        this.test_speed = test_speed;
    }

    public Integer getTest_brake() {
        return test_brake;
    }

    public void setTest_brake(Integer test_brake) {
        this.test_brake = test_brake;
    }

    public Integer getTest_oil() {
        return test_oil;
    }

    public void setTest_oil(Integer test_oil) {
