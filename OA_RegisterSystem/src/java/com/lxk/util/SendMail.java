...
public class SendMail extends Thread {
	...
	public void run() {
		try {
			...
			//设置邮件的内容
			msg.setContent("亲爱的小伙伴：<br/>恭喜您注册成为我们的一员，请猛戳<a href='http://localhost:8080/OA/login/LoginServlet?op=active&activeCode="+customer.getActiveCode()+"'>这里</a>激活您的账户。", "text/html;charset=UTF-8");
