...
<div style="position: relative;top: 10%;width: 80%;margin-left: 10%">
            <form action="/addJournal_had_catalog" method="post" id="addbook" >
                <div class="input-group">
                    <span class="input-group-addon">合订情况</span>
                    <input type="text" class="form-control" name="hdqk" id="hdqk" placeholder="请输入合订情况">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">编目日期</span>
                    <input type="text" class="form-control" name="bmrq" id="bmrq" placeholder="请输入编目日期">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">馆藏地</span>
                    <input type="text" class="form-control" name="gcd" id="gcd" placeholder="请输入馆藏地">
                </div>
