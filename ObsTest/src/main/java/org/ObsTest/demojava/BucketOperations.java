...
public class BucketOperations {
    ...
    public static void main(String[] args) {
        ...
        try{
            obsClient = new ObsClient(ak,sk,configuration);
            createBucket();
            getBucketLocation();
            getBucketStorageInfo();
            getBucketQuotaOperation();
    ...
    private static void doBucketWebsiteOperation() {
        ...
        WebsiteConfiguration websiteConfiguration = obsClient.getBucketWebsite(bucketName);
        System.out.println("\tIndex document="+websiteConfiguration.getKey()+",error document=\" + result.getSuffix()");
        System.out.println("Deletin bucket website");
    ...
    private static void optionsBucket() {
    ...
    private static void getBucketQuotaOperation() {
    ...
    private static void getBucketLocation() {
        ...
        System.out.println("Geting bucket location "+location);
    }

    private static void createBucket() throws ObsException{
