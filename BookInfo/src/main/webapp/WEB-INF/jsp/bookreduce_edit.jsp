...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑《 ${books.jsrq}》</h3>
        </div>
        <div class="panel-body">
            <form action="/doupdtebook_reduce?id=${books.jsrq}" method="post" id="addbook" >

                <div class="input-group">
                    <span class="input-group-addon">减少日期</span>
                    <input type="text"  readonly="readonly" class="form-control" name="jsrq" id="jsrq" value="${books.jsrq}" >
                </div>
                <div class="input-group">
                    <span class="input-group-addon">减少原因</span>
                    <input type="text" class="form-control" name="jsyy" id="jsyy" value="${books.jsyy}" >
                </div>
                <div class="input-group">
                    <span  class="input-group-addon">减少结果</span>
                    <input type="text" class="form-control" name="jsjg" id="jsjg"  value="${books.jsjg}" >
                </div>
                <div class="input-group">
                ...
                <script>
                    ...
                    $("#addbook").submit(function () {
                        if($("#jsrzgh").val()==''||$("#jsrq").val()==''||$("#jsjg").val()==''||$("#jsyy").val()==''){
                            alert("请填入完整订购图书信息！");
